...
mean(temp) # 13.49867°C
sd(temp)/length(temp) # 0.0002040612°C

#### 2.2   Lux ####
hist(lux) # extreme right skew
boxplot(lux, horizontal = T)
par(mfrow = c(1,1), mar = c(5, 4, 4, 2) + 0.1)
mean(lux*0.019) # 0.3633402 μmol photons m-2 s-1
sd(lux*0.019)/length(lux) # 0.0004602058 μmol photons m-2 s-1
range(lux*0.019) # 0-29.45 μmol photons m-2 s-1
