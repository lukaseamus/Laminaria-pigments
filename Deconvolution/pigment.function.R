...
##### Script purpose: Pigment function                       #####
...
core <- c("Chl.a", "Chl.c1", "Chl.c2", "Phe.a", "bb.Car", "Fuco", "Viola", "Zea")
...
# Estimating pigment weights using NNLS
pigment.fit <- function(w, y, pigments=core, k=6, m.bias= 0, s.bias= 1) {
	...
	# Fit each spectrum (column of y) by nnls (non-negative least squares)
